...
namespace WebBookLibrary.Models.LibraryModels
{
    public class JsonFileHandler : IFileHandler
    {
        private static readonly string PathToTheJsonFile =
            AppDomain.CurrentDomain.GetData("DataDirectory") + @"\LibraryBooks.json";
        ...
        {
            using (var fs = new FileStream(PathToTheJsonFile, FileMode.OpenOrCreate))
            {
        ...
        {
            using (var fs = new FileStream(PathToTheJsonFile, FileMode.Create))
            {
